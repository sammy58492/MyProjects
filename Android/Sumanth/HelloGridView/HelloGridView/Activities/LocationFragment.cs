...
{
    [Activity(Label = "LocationFragment")]
    public class LocationFragment : Android.Support.V4.App.Fragment
    {
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            View view = inflater.Inflate(Resource.Layout.LayoutFtagment, container, false);
           Button _button = view.FindViewById<Button>(Resource.Id.btnWall);
